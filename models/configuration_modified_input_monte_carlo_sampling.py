...
class ConfigurationModifiedInputMonteCarloSampling(Model):
    ...
    def __init__(self, monte_carlo_runs: int=None, marginal_distributions: List[str]=None):  # noqa: E501
        """ConfigurationModifiedInputMonteCarloSampling - a model defined in Swagger

        :param monte_carlo_runs: The monte_carlo_runs of this ConfigurationModifiedInputMonteCarloSampling.  # noqa: E501
        :type monte_carlo_runs: int
        :param marginal_distributions: The marginal_distributions of this ConfigurationModifiedInputMonteCarloSampling.  # noqa: E501
    ...
    @classmethod
    def from_dict(cls, dikt) -> 'ConfigurationModifiedInputMonteCarloSampling':
        """Returns the dict as a model

        :param dikt: A dict.
        :type: dict
        :return: The ConfigurationModifiedInput_monteCarloSampling of this ConfigurationModifiedInputMonteCarloSampling.  # noqa: E501
    ...
    def monte_carlo_runs(self) -> int:
        """Gets the monte_carlo_runs of this ConfigurationModifiedInputMonteCarloSampling.

        Number of Monte Carlo iterations.  # noqa: E501

        :return: The monte_carlo_runs of this ConfigurationModifiedInputMonteCarloSampling.
        :rtype: int
        """
    ...
    def monte_carlo_runs(self, monte_carlo_runs: int):
        """Sets the monte_carlo_runs of this ConfigurationModifiedInputMonteCarloSampling.

        Number of Monte Carlo iterations.  # noqa: E501

        :param monte_carlo_runs: The monte_carlo_runs of this ConfigurationModifiedInputMonteCarloSampling.
        :type monte_carlo_runs: int
        """
    ...
    def marginal_distributions(self) -> List[str]:
        """Gets the marginal_distributions of this ConfigurationModifiedInputMonteCarloSampling.

        The marginal distributions describing the indicators.  # noqa: E501

        :return: The marginal_distributions of this ConfigurationModifiedInputMonteCarloSampling.
        :rtype: List[str]
        """
    ...
    def marginal_distributions(self, marginal_distributions: List[str]):
        """Sets the marginal_distributions of this ConfigurationModifiedInputMonteCarloSampling.

        The marginal distributions describing the indicators.  # noqa: E501

        :param marginal_distributions: The marginal_distributions of this ConfigurationModifiedInputMonteCarloSampling.
        :type marginal_distributions: List[str]
        """
