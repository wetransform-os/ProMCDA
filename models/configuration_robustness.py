...
class ConfigurationRobustness(Model):
    ...
    def __init__(self, robustness: str=None, on_weights_level: str=None, given_weights: List[float]=None):  # noqa: E501
        """ConfigurationRobustness - a model defined in Swagger

        :param robustness: The robustness of this ConfigurationRobustness.  # noqa: E501
        :type robustness: str
        :param on_weights_level: The on_weights_level of this ConfigurationRobustness.  # noqa: E501
        :type on_weights_level: str
        :param given_weights: The given_weights of this ConfigurationRobustness.  # noqa: E501
    ...
    @classmethod
    def from_dict(cls, dikt) -> 'ConfigurationRobustness':
        """Returns the dict as a model

        :param dikt: A dict.
        :type: dict
        :return: The Configuration_robustness of this ConfigurationRobustness.  # noqa: E501
    ...
    def robustness(self) -> str:
        """Gets the robustness of this ConfigurationRobustness.

        A robustness analysis is performed ['yes'] or not ['no'].  # noqa: E501

        :return: The robustness of this ConfigurationRobustness.
        :rtype: str
        """
    ...
    def robustness(self, robustness: str):
        """Sets the robustness of this ConfigurationRobustness.

        A robustness analysis is performed ['yes'] or not ['no'].  # noqa: E501

        :param robustness: The robustness of this ConfigurationRobustness.
        :type robustness: str
        """
    ...
    def on_weights_level(self) -> str:
        """Gets the on_weights_level of this ConfigurationRobustness.

        Where uncertainties are introduced.  # noqa: E501

        :return: The on_weights_level of this ConfigurationRobustness.
        :rtype: str
        """
    ...
    def on_weights_level(self, on_weights_level: str):
        """Sets the on_weights_level of this ConfigurationRobustness.

        Where uncertainties are introduced.  # noqa: E501

        :param on_weights_level: The on_weights_level of this ConfigurationRobustness.
        :type on_weights_level: str
        """
    ...
    def given_weights(self) -> List[float]:
        """Gets the given_weights of this ConfigurationRobustness.

        Values assigned to the weights associated with the indicators.  # noqa: E501

        :return: The given_weights of this ConfigurationRobustness.
        :rtype: List[float]
        """
    ...
    def given_weights(self, given_weights: List[float]):
        """Sets the given_weights of this ConfigurationRobustness.

        Values assigned to the weights associated with the indicators.  # noqa: E501

        :param given_weights: The given_weights of this ConfigurationRobustness.
        :type given_weights: List[float]
        """
